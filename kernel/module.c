...
static void __module_enable_x(const struct module *mod,
			int (*set_memory)(unsigned long start, int num_pages))
{
...
{
	__module_enable_x(mod, set_memory_x);

#ifdef CONFIG_KVM_GUEST_HLAT
	__module_enable_x(mod, hlat_set_x);
#endif
}
...
static void module_enable_ro(const struct module *mod, bool after_init)
{
	...
	__module_enable_ro(mod, after_init, set_memory_ro);

#ifdef CONFIG_KVM_GUEST_HLAT
	__module_enable_ro(mod, after_init, hlat_set_ro);
#endif
}

static void __module_enable_nx(const struct module *mod, bool hlat,
			int (*set_memory)(unsigned long start, int num_pages))
{
	frob_rodata(&mod->core_layout, set_memory);
	frob_ro_after_init(&mod->core_layout, set_memory);
...
{
	__module_enable_nx(mod, false, set_memory_nx);

#ifdef CONFIG_KVM_GUEST_HLAT
	__module_enable_nx(mod, true, hlat_set_nx);
#endif
}
